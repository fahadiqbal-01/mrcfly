...
const TrackServicesBannerSec = () => {
  return (
    ...
    >
      <h1 className=" font-switzer-i xl:text-[48px] lg:text-[38px] md:text-[28px] text-[24px] text-center ">
      ...
      <p
        className=" font-G-Sans xl:text-[20px] lg:text-[18px] md:text-[14px] xl:leading-[32.5px] lg:leading-[32.5px] md:leading-[20px] leading-[20px] text-white 
